...
export const metadata: Metadata = {
  ...
  description: 'Descubra quantas repetições são necessárias, intervalos ideais, duração por ciclo. Maximize eficácia sem danificar speaker.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/som-ejecao-agua/quantas-vezes',
  },
  openGraph: {
    title: 'Quantas Vezes Usar Som de Ejeção? Repetições Ideais 2026',
    description: 'Descubra quantas repetições são necessárias, intervalos ideais, duração por ciclo. Maximize eficácia sem danificar speaker.',
    url: 'https://www.ejetaragua.com/guias/som-ejecao-agua/quantas-vezes',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Quantas Vezes Usar Som de Ejeção? Repetições Ideais 2026',
    description: 'Descubra quantas repetições são necessárias, intervalos ideais, duração por ciclo. Maximize eficácia sem danificar speaker.',
    url: '/guias/som-ejecao-agua/quantas-vezes',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Quantas Vezes Repetir: Protocolo Ideal
          </h1>
