...
export const metadata: Metadata = {
  ...
  description: 'Microfone do celular abafado depois que molhou? Som de ejeção 165Hz resolve em 70% dos casos. Guia completo de recuperação.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/celular-molhado/microfone-abafado',
  },
  openGraph: {
    title: 'Microfone Abafado Após Molhar: Como Resolver 2026',
    description: 'Microfone do celular abafado depois que molhou? Som de ejeção 165Hz resolve em 70% dos casos. Guia completo de recuperação.',
    url: 'https://www.ejetaragua.com/guias/celular-molhado/microfone-abafado',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Microfone Abafado Após Molhar: Como Resolver 2026',
    description: 'Microfone do celular abafado depois que molhou? Som de ejeção 165Hz resolve em 70% dos casos. Guia completo de recuperação.',
    url: '/guias/celular-molhado/microfone-abafado',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Microfone Abafado: Solução Definitiva
          </h1>
