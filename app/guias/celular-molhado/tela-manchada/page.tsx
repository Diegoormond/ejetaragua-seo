...
export const metadata: Metadata = {
  ...
  description: 'Manchas na tela depois que celular molhou? Entenda se é temporário ou permanente, como secar, e quando precisa trocar o display.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/celular-molhado/tela-manchada',
  },
  openGraph: {
    title: 'Tela Manchada Após Molhar Celular: Conserta? | 2026',
    description: 'Manchas na tela depois que celular molhou? Entenda se é temporário ou permanente, como secar, e quando precisa trocar o display.',
    url: 'https://www.ejetaragua.com/guias/celular-molhado/tela-manchada',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Tela Manchada Após Molhar Celular: Conserta? | 2026',
    description: 'Manchas na tela depois que celular molhou? Entenda se é temporário ou permanente, como secar, e quando precisa trocar o display.',
    url: '/guias/celular-molhado/tela-manchada',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Tela Manchada Por Água: Tem Solução?
          </h1>
