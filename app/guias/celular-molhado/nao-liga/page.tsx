...
export const metadata: Metadata = {
  ...
  description: 'Celular molhado não liga mais? Descubra se é bateria, curto-circuito, ou placa-mãe. Quando tem conserto e quanto custa.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/celular-molhado/nao-liga',
  },
  openGraph: {
    title: 'Celular Molhado Não Liga: Diagnóstico e Soluções 2026',
    description: 'Celular molhado não liga mais? Descubra se é bateria, curto-circuito, ou placa-mãe. Quando tem conserto e quanto custa.',
    url: 'https://www.ejetaragua.com/guias/celular-molhado/nao-liga',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Celular Molhado Não Liga: Diagnóstico e Soluções 2026',
    description: 'Celular molhado não liga mais? Descubra se é bateria, curto-circuito, ou placa-mãe. Quando tem conserto e quanto custa.',
    url: '/guias/celular-molhado/nao-liga',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Celular Molhado Não Liga: O Que Fazer
          </h1>
