...
export const metadata: Metadata = {
  ...
  description: 'Celular carregando devagar após molhar? Porta oxidada, cabo com problema, ou IC de carga danificado. Diagnóstico.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/problemas/carregamento-lento',
  },
  openGraph: {
    title: 'Carregamento Lento Depois que Molhou Celular | 2026',
    description: 'Celular carregando devagar após molhar? Porta oxidada, cabo com problema, ou IC de carga danificado. Diagnóstico.',
    url: 'https://www.ejetaragua.com/guias/problemas/carregamento-lento',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Carregamento Lento Depois que Molhou Celular | 2026',
    description: 'Celular carregando devagar após molhar? Porta oxidada, cabo com problema, ou IC de carga danificado. Diagnóstico.',
    url: '/guias/problemas/carregamento-lento',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Carregamento Lento: Diagnóstico
          </h1>
