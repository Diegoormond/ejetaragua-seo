...
export const metadata: Metadata = {
  ...
  description: 'Face ID não funciona após iPhone molhar? Sensores TrueDepth e água. Quando volta a funcionar, quando precisa trocar.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/problemas/face-id-parou',
  },
  openGraph: {
    title: 'Face ID Parou Depois que iPhone Molhou | Consertar 2026',
    description: 'Face ID não funciona após iPhone molhar? Sensores TrueDepth e água. Quando volta a funcionar, quando precisa trocar.',
    url: 'https://www.ejetaragua.com/guias/problemas/face-id-parou',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Face ID Parou Depois que iPhone Molhou | Consertar 2026',
    description: 'Face ID não funciona após iPhone molhar? Sensores TrueDepth e água. Quando volta a funcionar, quando precisa trocar.',
    url: '/guias/problemas/face-id-parou',
