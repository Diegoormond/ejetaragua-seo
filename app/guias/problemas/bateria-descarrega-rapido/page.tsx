...
export const metadata: Metadata = {
  ...
  description: 'Bateria descarregando rápido após molhar? Causas: curto-circuito, placa oxidada, bateria danificada. Diagnóstico e soluções.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/problemas/bateria-descarrega-rapido',
  },
  openGraph: {
    title: 'Bateria Descarrega Rápido Depois que Molhou | Resolver 2026',
    description: 'Bateria descarregando rápido após molhar? Causas: curto-circuito, placa oxidada, bateria danificada. Diagnóstico e soluções.',
    url: 'https://www.ejetaragua.com/guias/problemas/bateria-descarrega-rapido',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Bateria Descarrega Rápido Depois que Molhou | Resolver 2026',
    description: 'Bateria descarregando rápido após molhar? Causas: curto-circuito, placa oxidada, bateria danificada. Diagnóstico e soluções.',
    url: '/guias/problemas/bateria-descarrega-rapido',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Bateria Descarrega Rápido: O Que Fazer
          </h1>
