...
export const metadata: Metadata = {
  ...
  description: 'Tabela de preços: troca de tela, bateria, placa-mãe, speaker. Quando vale a pena consertar vs comprar novo.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/problemas/quanto-custa-consertar',
  },
  openGraph: {
    title: 'Quanto Custa Consertar Celular Molhado? Preços 2026',
    description: 'Tabela de preços: troca de tela, bateria, placa-mãe, speaker. Quando vale a pena consertar vs comprar novo.',
    url: 'https://www.ejetaragua.com/guias/problemas/quanto-custa-consertar',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Quanto Custa Consertar Celular Molhado? Preços 2026',
    description: 'Tabela de preços: troca de tela, bateria, placa-mãe, speaker. Quando vale a pena consertar vs comprar novo.',
    url: '/guias/problemas/quanto-custa-consertar',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Preços de Conserto: Tabela Completa
          </h1>
