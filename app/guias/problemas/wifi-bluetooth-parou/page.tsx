...
export const metadata: Metadata = {
  ...
  description: 'WiFi e Bluetooth não funcionam após molhar? Antenas, IC de rádio, placa-mãe. Quando tem conserto.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/problemas/wifi-bluetooth-parou',
  },
  openGraph: {
    title: 'WiFi e Bluetooth Pararam Depois que Molhou | Resolver 2026',
    description: 'WiFi e Bluetooth não funcionam após molhar? Antenas, IC de rádio, placa-mãe. Quando tem conserto.',
    url: 'https://www.ejetaragua.com/guias/problemas/wifi-bluetooth-parou',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'WiFi e Bluetooth Pararam Depois que Molhou | Resolver 2026',
    description: 'WiFi e Bluetooth não funcionam após molhar? Antenas, IC de rádio, placa-mãe. Quando tem conserto.',
    url: '/guias/problemas/wifi-bluetooth-parou',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            WiFi/Bluetooth Pararam: Solução
          </h1>
