...
export const metadata: Metadata = {
  ...
  description: 'Usar ventilador para secar celular é seguro mas lento. Posição correta, tempo necessário, eficácia. Compare com outros métodos.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/solucoes/ventilador',
  },
  openGraph: {
    title: 'Ventilador Para Secar Celular: Funciona? Quanto Tempo? 2026',
    description: 'Usar ventilador para secar celular é seguro mas lento. Posição correta, tempo necessário, eficácia. Compare com outros métodos.',
    url: 'https://www.ejetaragua.com/guias/solucoes/ventilador',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Ventilador: Método Lento Mas Seguro
          </h1>
