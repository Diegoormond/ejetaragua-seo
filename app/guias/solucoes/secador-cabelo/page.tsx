...
export const metadata: Metadata = {
  ...
  description: 'Secador de cabelo danifica celular molhado? Temperatura segura, distância, riscos. Alternativas mais seguras.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/solucoes/secador-cabelo',
  },
  openGraph: {
    title: 'Pode Usar Secador de Cabelo em Celular Molhado? | 2026',
    description: 'Secador de cabelo danifica celular molhado? Temperatura segura, distância, riscos. Alternativas mais seguras.',
    url: 'https://www.ejetaragua.com/guias/solucoes/secador-cabelo',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Pode Usar Secador de Cabelo em Celular Molhado? | 2026',
    description: 'Secador de cabelo danifica celular molhado? Temperatura segura, distância, riscos. Alternativas mais seguras.',
    url: '/guias/solucoes/secador-cabelo',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Secador de Cabelo: Pode ou Não Pode?
          </h1>
