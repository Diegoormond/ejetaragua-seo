...
export const metadata: Metadata = {
  ...
  description: 'Álcool isopropílico 99% seca celular? Como usar, riscos, diferença do álcool 70%. Método para técnicos.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/solucoes/alcool-isopropilico',
  },
  openGraph: {
    title: 'Álcool Isopropílico Para Secar Celular: Como Usar 2026',
    description: 'Álcool isopropílico 99% seca celular? Como usar, riscos, diferença do álcool 70%. Método para técnicos.',
    url: 'https://www.ejetaragua.com/guias/solucoes/alcool-isopropilico',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Álcool Isopropílico Para Secar Celular: Como Usar 2026',
    description: 'Álcool isopropílico 99% seca celular? Como usar, riscos, diferença do álcool 70%. Método para técnicos.',
    url: '/guias/solucoes/alcool-isopropilico',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Álcool Isopropílico: Método Profissional
          </h1>
