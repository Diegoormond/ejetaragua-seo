...
export const metadata: Metadata = {
  ...
  description: 'Silica gel é 10x mais eficaz que arroz. Aprenda a usar corretamente: quantidade, tempo, recipiente. Onde conseguir sachês.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/solucoes/silica-gel',
  },
  openGraph: {
    title: 'Silica Gel Para Secar Celular: Como Usar Corretamente 2026',
    description: 'Silica gel é 10x mais eficaz que arroz. Aprenda a usar corretamente: quantidade, tempo, recipiente. Onde conseguir sachês.',
    url: 'https://www.ejetaragua.com/guias/solucoes/silica-gel',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Silica Gel: Método Científico de Secagem
          </h1>
