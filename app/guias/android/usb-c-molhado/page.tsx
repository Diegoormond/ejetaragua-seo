...
export const metadata: Metadata = {
  ...
  description: 'Porta USB-C do Android molhada? Descubra se pode carregar, como secar corretamente, e quando o alerta de umidade aparece.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/android/usb-c-molhado',
  },
  openGraph: {
    title: 'Porta USB-C Molhada: Pode Carregar? Como Secar 2026',
    description: 'Porta USB-C do Android molhada? Descubra se pode carregar, como secar corretamente, e quando o alerta de umidade aparece.',
    url: 'https://www.ejetaragua.com/guias/android/usb-c-molhado',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Porta USB-C Molhada: Pode Carregar? Como Secar 2026',
    description: 'Porta USB-C do Android molhada? Descubra se pode carregar, como secar corretamente, e quando o alerta de umidade aparece.',
    url: '/guias/android/usb-c-molhado',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Porta USB-C Molhada: O Que Fazer
          </h1>
