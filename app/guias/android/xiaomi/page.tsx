...
export const metadata: Metadata = {
  ...
  description: 'Xiaomi molhado? Guia para Redmi Note, Poco, Mi 11/12/13. Quais têm IP68, como ejetar água, e recuperação.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/android/xiaomi',
  },
  openGraph: {
    title: 'Xiaomi Molhado: Redmi/Poco/Mi - Como Salvar 2026',
    description: 'Xiaomi molhado? Guia para Redmi Note, Poco, Mi 11/12/13. Quais têm IP68, como ejetar água, e recuperação.',
    url: 'https://www.ejetaragua.com/guias/android/xiaomi',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Xiaomi Molhado: Guia Para Todos os Modelos
          </h1>
