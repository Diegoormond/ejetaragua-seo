...
export const metadata: Metadata = {
  ...
  description: 'Tela tocando sozinha depois que Android molhou? Touch fantasma: causas, soluções, e quando precisa trocar o display.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/android/touch-fantasma',
  },
  openGraph: {
    title: 'Touch Fantasma Depois que Molhou Android | Consertar 2026',
    description: 'Tela tocando sozinha depois que Android molhou? Touch fantasma: causas, soluções, e quando precisa trocar o display.',
    url: 'https://www.ejetaragua.com/guias/android/touch-fantasma',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Touch Fantasma Depois que Molhou Android | Consertar 2026',
    description: 'Tela tocando sozinha depois que Android molhou? Touch fantasma: causas, soluções, e quando precisa trocar o display.',
    url: '/guias/android/touch-fantasma',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Touch Fantasma Após Molhar: Solução
          </h1>
