...
export const metadata: Metadata = {
  ...
  description: 'Som abafado depois que molhou? Método de ejeção por ondas sonoras resolve em 85% dos casos. Guia passo a passo.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/alto-falante/som-abafado',
  },
  openGraph: {
    title: 'Som do Celular Abafado: Como Resolver Definitivamente 2026',
    description: 'Som abafado depois que molhou? Método de ejeção por ondas sonoras resolve em 85% dos casos. Guia passo a passo.',
    url: 'https://www.ejetaragua.com/guias/alto-falante/som-abafado',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Som Abafado: Solução Definitiva
          </h1>
