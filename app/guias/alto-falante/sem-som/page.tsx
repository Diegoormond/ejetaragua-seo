...
export const metadata: Metadata = {
  ...
  description: 'Alto-falante parou totalmente? Entenda se é água, dano na bobina, ou membrana rompida. Quando tem conserto.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/alto-falante/sem-som',
  },
  openGraph: {
    title: 'Alto-Falante Sem Som Depois que Molhou | Consertar 2026',
    description: 'Alto-falante parou totalmente? Entenda se é água, dano na bobina, ou membrana rompida. Quando tem conserto.',
    url: 'https://www.ejetaragua.com/guias/alto-falante/sem-som',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Alto-Falante Sem Som Depois que Molhou | Consertar 2026',
    description: 'Alto-falante parou totalmente? Entenda se é água, dano na bobina, ou membrana rompida. Quando tem conserto.',
    url: '/guias/alto-falante/sem-som',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Alto-Falante Sem Som: Diagnóstico
          </h1>
