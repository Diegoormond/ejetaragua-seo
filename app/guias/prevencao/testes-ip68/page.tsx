...
export const metadata: Metadata = {
  ...
  description: 'Entenda os testes IP68: profundidade, duração, condições. Por que fabricantes fazem e o que realmente significa.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/prevencao/testes-ip68',
  },
  openGraph: {
    title: 'Como São Feitos os Testes de Certificação IP68? 2026',
    description: 'Entenda os testes IP68: profundidade, duração, condições. Por que fabricantes fazem e o que realmente significa.',
    url: 'https://www.ejetaragua.com/guias/prevencao/testes-ip68',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Como São Feitos os Testes de Certificação IP68? 2026',
    description: 'Entenda os testes IP68: profundidade, duração, condições. Por que fabricantes fazem e o que realmente significa.',
    url: '/guias/prevencao/testes-ip68',
