...
export const metadata: Metadata = {
  ...
  description: 'Review das melhores capas impermeáveis no Brasil: LifeProof, Otterbox, Catalyst, Geonav. Preços, onde comprar, eficácia.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/prevencao/capas-impermeaveis',
  },
  openGraph: {
    title: 'Melhores Capas Impermeáveis Para Celular | Brasil 2026',
    description: 'Review das melhores capas impermeáveis no Brasil: LifeProof, Otterbox, Catalyst, Geonav. Preços, onde comprar, eficácia.',
    url: 'https://www.ejetaragua.com/guias/prevencao/capas-impermeaveis',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Melhores Capas Impermeáveis Para Celular | Brasil 2026',
    description: 'Review das melhores capas impermeáveis no Brasil: LifeProof, Otterbox, Catalyst, Geonav. Preços, onde comprar, eficácia.',
    url: '/guias/prevencao/capas-impermeaveis',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Melhores Capas Impermeáveis 2026
          </h1>
