...
export const metadata: Metadata = {
  ...
  description: 'Pode levar celular IP68 na piscina? Cloro corrói? Descubra os riscos e como proteger corretamente.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/prevencao/piscina-cloro',
  },
  openGraph: {
    title: 'Celular na Piscina: Cloro Estraga? IP68 Protege? 2026',
    description: 'Pode levar celular IP68 na piscina? Cloro corrói? Descubra os riscos e como proteger corretamente.',
    url: 'https://www.ejetaragua.com/guias/prevencao/piscina-cloro',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Celular na Piscina: Cloro Estraga? IP68 Protege? 2026',
    description: 'Pode levar celular IP68 na piscina? Cloro corrói? Descubra os riscos e como proteger corretamente.',
    url: '/guias/prevencao/piscina-cloro',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Celular na Piscina: Riscos do Cloro
          </h1>
