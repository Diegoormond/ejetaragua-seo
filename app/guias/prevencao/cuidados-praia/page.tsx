...
export const metadata: Metadata = {
  ...
  description: 'Cuidados essenciais para levar celular à praia: proteção contra areia, água salgada, sol. Capas, bolsas, e técnicas.',
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: 'https://www.ejetaragua.com/guias/prevencao/cuidados-praia',
  },
  openGraph: {
    title: 'Como Usar Celular na Praia Sem Estragar | Guia 2026',
    description: 'Cuidados essenciais para levar celular à praia: proteção contra areia, água salgada, sol. Capas, bolsas, e técnicas.',
    url: 'https://www.ejetaragua.com/guias/prevencao/cuidados-praia',
...
export default function Page() {
  ...
  const articleSchema = createArticleSchema({
    title: 'Como Usar Celular na Praia Sem Estragar | Guia 2026',
    description: 'Cuidados essenciais para levar celular à praia: proteção contra areia, água salgada, sol. Capas, bolsas, e técnicas.',
    url: '/guias/prevencao/cuidados-praia',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Celular na Praia: Cuidados Essenciais
          </h1>
